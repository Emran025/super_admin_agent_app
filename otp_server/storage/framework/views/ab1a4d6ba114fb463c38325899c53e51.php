    ...
    <?php if(isset($newSystem, $newToken, $newKey)): ?>
        ...
        <script>
            const config = JSON.stringify({
                ...
                capabilities: <?php echo json_encode($newSystem->capabilities, 15, 512) ?>,
                is_test: true
            });
...
<?php /**PATH C:\xampp\htdocs\SuperAdmin\otp_server\resources\views/testbed/system-pairing.blade.php ENDPATH**/ ?>