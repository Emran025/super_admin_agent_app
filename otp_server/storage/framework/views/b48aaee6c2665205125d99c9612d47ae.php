...
<div class="card">
    ...
    <?php if(isset($error)): ?>
        <div class="error-list"><li><?php echo e($error); ?></li></div>
    <?php endif; ?>

    <form method="POST" action="<?php echo e(route('testbed.sms.dispatch')); ?>" novalidate>
        <?php echo csrf_field(); ?>
        ...
        <div class="form-group">
            ...
            <input
                ...
                class="<?php echo e($errors->has('full_name') ? 'error-field' : ''); ?>"
            >
        ...
        <div class="form-group">
            ...
            <div class="phone-wrap">
                ...
                <input
                    ...
                    class="<?php echo e($errors->has('phone_number') ? 'error-field' : ''); ?>"
                >
            </div>
...
<?php /**PATH /home/runner/workspace/otp_server/resources/views/testbed/sms/phone.blade.php ENDPATH**/ ?>