        ...
        <div class="alert-warning">
            ...
            <div class="qr-block">
                <div style="background: #ffffff; padding: 1.25rem; border-radius: 12px; display: inline-block; box-shadow: 0 4px 20px rgba(0,0,0,0.5); margin: 0.5rem 0;" data-darkreader-ignore>
                    <div id="qrcode" data-capabilities='<?php echo json_encode($newSystem->capabilities, 15, 512) ?>' style="color-scheme: light;"></div>
                </div>
...
</html><?php /**PATH /app/otp_server/resources/views/testbed/system-pairing.blade.php ENDPATH**/ ?>